        ...
        with Vertical(id="help-sheet"):
            ...
            yield Static(
                Text.assemble(
                    ...
                    ("RUNS\n", palette.hold),
                    "enter  Adopt a paused run, or inspect any run read-only\n",
                    "d      Delete the selected run directory (confirmation required)\n",
                    "Deletion refuses a live-owned, running, or currently open run.\n\n",
                    ("GATES\n", palette.cold),
