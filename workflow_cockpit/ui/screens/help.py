        ...
        with Vertical(id="help-sheet"):
            ...
            yield Static(
                Text.assemble(
                    ...
                    "s  Show state     g  Show paused gate     c  Show Worktree Changes\n",
                    "l  Expand Engine Output / return to live tail\n",
                    "e  Collapse Engine Output        End  Output tail\n",
                    "d  Diff view     r  Rendered view     f  Full file\n",
                    "/  Filter changed paths     o  Open selected file in $EDITOR\n\n",
                    ("DECIDE\n", HOLD),
                    ...
                    ("S03 SCOPE\n", COLD),
                    "Worktree Changes compares the worktree with the Start commit.\n",
